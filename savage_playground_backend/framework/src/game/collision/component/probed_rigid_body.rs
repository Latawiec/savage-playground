...
use bevy_rapier2d::prelude::{
    Collider, CollisionGroups, Damping, Group, LockedAxes, RigidBody, Vect,
};

use crate::game::collision::collision_groups::*;
...
impl PhysicsProbeBundle {
    ...
    fn collision_groups() -> CollisionGroups {
        CollisionGroups {
            ...
            filters: Group::from(Group::from_bits_truncate(
                COLLISION_PLAYER | COLLISION_OBSTACLES,
            )),
        }
    }
}
