...
use ffxiv_toolkit::{input::event::FFXIVGameInputEvent, player::component::{FfxivToolkitPlayerBundle, PlayerController, PlayerInfo}, plugin::FfxivToolkitPlugin};
use game_config::game_args::GameArgs;
use tracing::info;

fn main() {
    let game_args = GameArgs::new("FFXIV Toolkit Debug - debugging Bevy-based game.");
