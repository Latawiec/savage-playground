...
export const DrawBundle = {
  encode(message: DrawBundle, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.vertexShaderAsset !== undefined) {
      writer.uint32(34).string(message.vertexShaderAsset);
    }
    if (message.vertexAttributes !== undefined) {
      VertexAttributes.encode(message.vertexAttributes, writer.uint32(42).fork()).ldelim();
    }
    if (message.pixelShaderAsset !== undefined) {
      writer.uint32(50).string(message.pixelShaderAsset);
    }
    if (message.uniformAttributes !== undefined) {
      UniformAttributes.encode(message.uniformAttributes, writer.uint32(58).fork()).ldelim();
    }
    if (message.meshAsset !== undefined) {
      writer.uint32(66).string(message.meshAsset);
    }
    for (const v of message.textures) {
      Texture.encode(v!, writer.uint32(74).fork()).ldelim();
    }
    return writer;
  },
...
function createBaseSceneElement(): SceneElement {
  return { id: 0, drawBundle: undefined, updateType: undefined };
}
...
export const SceneElement = {
  encode(message: SceneElement, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.updateType !== undefined) {
      writer.uint32(24).int32(message.updateType);
    }
    return writer;
  },
...
function createBaseSceneUpdate(): SceneUpdate {
  return { index: 0, sharedAttributes: undefined, elements: [] };
}
