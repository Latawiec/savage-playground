use super::{class::Class, role::Role};
...
pub const VIPER: (Class, Role, Job) = (Class::MeleeDamage, Role::DPS, Job::VIP);
...
pub const PICTOMANCER: (Class, Role, Job) = (Class::MagicalRangedDamage, Role::DPS, Job::PIC);