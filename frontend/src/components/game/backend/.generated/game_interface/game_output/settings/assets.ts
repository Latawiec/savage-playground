...
function createBaseAssets(): Assets {
  return { assetsPackagePath: undefined };
}

export const Assets = {
  encode(message: Assets, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.assetsPackagePath !== undefined) {
      writer.uint32(10).string(message.assetsPackagePath);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.assetsPackagePath = reader.string();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): Assets {
    return {
      assetsPackagePath: isSet(object.assetsPackagePath) ? globalThis.String(object.assetsPackagePath) : undefined,
    };
  },
  ...
  toJSON(message: Assets): unknown {
    const obj: any = {};
    if (message.assetsPackagePath !== undefined) {
      obj.assetsPackagePath = message.assetsPackagePath;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Assets>, I>>(object: I): Assets {
    const message = createBaseAssets();
    message.assetsPackagePath = object.assetsPackagePath ?? undefined;
    return message;
  },
};
